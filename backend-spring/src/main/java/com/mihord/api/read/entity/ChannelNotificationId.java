...
@Embeddable
public class ChannelNotificationId implements Serializable {
    ...
    public ChannelNotificationId() {}
    public ChannelNotificationId(String userId, String channelId) {
        this.userId = userId;
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof ChannelNotificationId i)) return false;
